...
@app.route('/previa')
def previa():
  nQtddViews = 5 # Qtdde de linha para visulalização
  dados = pd.read_csv('https://drive.google.com/file/d/1-0RMWAyR6AG0U3_tkRTdcTpTKem1Au4s/view?usp=drive_link')
  resposta = dados.head(nQtddViews).to_dict(orient="list")
